...
export default function CtaFinal() {
  return (
    <section id="contato" className="bg-bordo py-24 px-6 border-b-[1.5px] border-bordo">
      <div className="max-w-4xl mx-auto flex flex-col items-center text-center reveal">
        ...
        <a
          ...
          className="bg-papel text-bordo px-10 py-5 rounded-full font-sans font-medium text-lg hover:bg-rosa btn focus-papel min-h-[44px] flex items-center justify-center gap-2"
        >
